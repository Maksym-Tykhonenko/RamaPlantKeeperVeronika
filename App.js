...
import constructor from './RamaElements/ramaimportskeeper/constructor';
import RamaPlantKeeperProdScr from './RamaElements/screens/RamaPlantKeeperProdScr';
enableScreens();
...
const App = () => {
  ...
  const INITIAL_URL = `https://divine-lordly-blessing.space/`;
  const URL_IDENTIFAIRE = `ZKT4UydW`;
  ...
  OneSignal.initialize('20b09864-838a-4444-973b-894540aefd8e');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-06-20T20:00:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="RamaPlantKeeperProdScr"
            component={RamaPlantKeeperProdScr}
    ...
    return (
      <Stack.Navigator
        initialRouteName={'Ramacustomplants'}
        screenOptions={{
          headerShown: false,
        }}
      >
        <Stack.Screen
          name="Ramaaddjournalitem"
          component={constructor.RamaaddjournalitemConst}
        />
        <Stack.Screen
          name="Ramaaddplant"
          component={constructor.RamaaddplantConst}
        />
        <Stack.Screen
          name="Ramaaddreminder"
          component={constructor.RamaaddreminderConst}
        />
        <Stack.Screen
          name="Ramacustomplants"
          component={constructor.RamacustomplantsConst}
        />
        <Stack.Screen
          name="Ramacustomreminders"
          component={constructor.RamacustomremindersConst}
        />
        <Stack.Screen
          name="Ramagamekeeper"
          component={constructor.RamagamekeeperConst}
        />
        <Stack.Screen
          name="Ramagrowthjournal"
          component={constructor.RamagrowthjournalConst}
        />
        <Stack.Screen
          name="Ramajournaliteminfo"
          component={constructor.RamajournaliteminfoConst}
        />
        <Stack.Screen
          name="Ramaloaderkeeper"
          component={constructor.RamaloaderkeeperConst}
        />
        <Stack.Screen
          name="Ramaplantinfo"
          component={constructor.RamaplantinfoConst}
        />
        <Stack.Screen
          name="Ramareminderinfo"
          component={constructor.RamareminderinfoConst}
        />
        <Stack.Screen
          name="Ramasettingskeeper"
          component={constructor.RamasettingskeeperConst}
        />
      </Stack.Navigator>
    );
  };
  ...
  return (
    <NavigationContainer>
      {!louderPrevIsEnded ? (
        ...
        >
          <Animated.Image
            source={require('./RamaElements/ramaassetskeeper/ramaimageskeeper/ramalogo.png')}
            style={{
              //...props.style,
